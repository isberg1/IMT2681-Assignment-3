...
func main() {
	...
	//r.Handle("/pictures/{rest}", http.StripPrefix("/pictures/", http.FileServer(http.Dir("./website/static/pictures/"))))

	r.PathPrefix("/pictures/").Handler(http.StripPrefix("/pictures/", http.FileServer(http.Dir("./website/static/pictures/"))))
